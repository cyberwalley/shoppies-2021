...
export const Tab = ({ movies, nominatedMovieItems, movieListMarkup, nominationsMarkup, loading }) => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      contentMarkUp:  nominatedMovieItems.length > 0 ? nominationsMarkup : <EmptyStates heading={'Nominate a movie and it will show up here.'} subheading={'Nominate a movie and it will show up here.'} image='https://cdn.shopify.com/s/files/1/2506/6936/files/nomination-empty-state-2.svg?v=1609785285' />,
